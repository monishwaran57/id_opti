...
def give_parent_pipe(child_start_node):
...
for i, pipe_row in df_sorted.iterrows():
    ...
    parent_pipe_dict = give_parent_pipe(pipe_row['start_node'])
    ...
    while parent_pipe_dict is not None:
        ...
        parent_pipe_dict = give_parent_pipe(parent_pipe_dict['start_node'])
